...
faust/                            fourteen canonical versioned effect sources
...
- Gate 2: real Gain, Filter, Saturation, Delay, Reverb, Chorus, Compressor, Phaser, Auto Wah, Stutter, 3-Band EQ, Limiter, Flanger, and Tremolo Faust/WASM browser processors.
