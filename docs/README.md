...
- [Project model](project-model.md): ProjectV2, migration, commands, Controls, history, and persistence.
- [Audio engine](audio-engine.md): canonical Faust definitions, browser processing, comparison, and safety analysis.
- [WebMCP](webmcp.md): five task-level tools, prompt-related Controls, revision safety, and approval behavior.
